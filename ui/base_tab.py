...
class BaseTab(ttk.Frame):
    ...
    def selecionar_arquivo(self, label_widget, target_path_attr='filepath'):
        ...
        if filepath:
            ...
            label_widget.config(text=os.path.basename(filepath))
    ...
    def salvar_dataframe(self, df_to_save, is_unifier=False):
        ...
        initial_filename = "UNIFICADO" if is_unifier else f"processado_{os.path.basename(self.filepath or 'arquivo')}"
